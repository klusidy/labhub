...
import yaml
import logging
logger = logging.getLogger("labhub.tray")
...
logger.debug(f"project_root is {PROJECT_ROOT}")
logger.debug(f"hub_dir is {HUB_DIR}")
...
class TrayApp:
    ...
    def reload_server(self):
        logger.info(" -- reloading") # todo check if server is running and not do this if not
        try:
